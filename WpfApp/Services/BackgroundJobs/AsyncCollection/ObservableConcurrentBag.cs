...
namespace wpfapp.Services.BackgroundJob
{
    ...
    public class ObservableConcurrentQueue<T> : IProducerConsumerCollection<T>,
        IEnumerable<T>, ICollection, IEnumerable
    {
        ...
        /// </summary>
        public ObservableConcurrentQueue(Dispatcher dispatcher)
        {
        ...
        /// </summary>
        public ObservableConcurrentQueue(Dispatcher dispatcher, IEnumerable<T> collection)
        {
            this.dispatcher = dispatcher;
